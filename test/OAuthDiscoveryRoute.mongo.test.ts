...
// isolation from a live `ObjectFactory`. `Server.mongo.test.ts` already exercises route
// registration end-to-end, but never calls the discovery endpoint itself.
import { describe, expect, it } from "vitest";
import { OAuthDiscoveryRoute } from "../src/mongo/routes/OAuthDiscoveryRoute.js";

describe("OAuthDiscoveryRoute (mongo)", () => {
