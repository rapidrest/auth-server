...
// from a live `ObjectFactory`/database. `Server.mongo.test.ts` already exercises route registration
...
import { AuthAppleRoute } from "../src/mongo/routes/AuthAppleRoute.js";

afterEach(() => {
    vi.restoreAllMocks();
});

describe("AuthAppleRoute (mongo)", () => {
