...
do
    case "$1" in
        ...
        -h | --help)
          ...
          echo "Usage:"
          echo -e "\t--domain <domain>\t\tThe domain name to use for the deployment of auth-server"
...
helm upgrade --install --create-namespace --namespace $NAMESPACE $NAMESPACE oci://ghcr.io/rapidrest/charts/auth-server \
